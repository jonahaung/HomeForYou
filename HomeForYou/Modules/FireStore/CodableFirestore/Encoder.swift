...
private struct _FirebaseEncodingStorage {
    // MARK: Properties
    /// The container stack.
...
private struct _FirebaseKeyedEncodingContainer<K: CodingKey>: KeyedEncodingContainerProtocol {
    typealias Key = K
...
private struct _FirebaseUnkeyedEncodingContainer: UnkeyedEncodingContainer {
    // MARK: Properties
    /// A reference to the encoder we're writing to.
    private let encoder: _FirebaseEncoder
...
private class _FirebaseReferencingEncoder: _FirebaseEncoder {
